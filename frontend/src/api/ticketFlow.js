...
export const getLatestReservation = (params) => http.get('/api/reservations/latest', { params })
...
export const getTicketDynamicCode = (id) => http.get(`/api/user/tickets/${id}/dynamic-code`)
